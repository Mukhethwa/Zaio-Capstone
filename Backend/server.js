...
const path = require('path'); //Added to resolve absolute paths for static folder routing
...
mongoose.set('bufferCommands', false); // Disables command buffering to fail fast if disconnected
...
//Administrative Oversight Dashboard Routes
app.use('/api/admin', require('./routes/adminRoutes'));

//Centralized Global Error Handling Interceptor Middleware (FIXED TYPO HERE)
...
app.listen(PORT, () => {
    console.log(`SERVER RUNNING: Active and listening on port ${PORT}`);
});